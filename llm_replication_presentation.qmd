...
- **Shared logic**: both repurpose human inter-coder reliability statistics for a new kind of "rater" — the LLM
...
4. **Document everything** — model, version, prompt, settings, date run
5. **Prefer open, versioned models** where the task allows it
:::
